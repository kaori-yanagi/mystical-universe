...
//型を付ける
//absolute関数で cnoizu切りとってあげる　そうすると　-の部分が＋にかわる
// elevation += cnoise(vec3(modelPosition.xz * 3.0, uTime * 0.2)) * 0.15; 丸がかった表現

// elevation -= abs(cnoise(vec3(modelPosition.xz * 3.0, uTime * 0.2))) * 0.15;谷を-にした
...
//細かくしてくと uSmallWaveElevationを0.15に貼り付ける
